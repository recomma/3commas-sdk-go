...
func main() {
	...
	file, err := parser.ParseFile(fset, "threecommas/openapi.gen.go", nil, parser.ParseComments)
	if err != nil {
		fmt.Fprintln(os.Stderr, "Error parsing openapi.gen.go:", err)
		os.Exit(1)
	}

	var builder strings.Builder
	builder.WriteString("// Code generated by error_helpers_gen.go; DO NOT EDIT.\n\n")
	builder.WriteString("package threecommas\n\n")
